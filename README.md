...
#### Client-side Routing is beneficial because it allows a page to load more smothly and to react quickly to user actions since it does not send a server request after each link or form interaction.
